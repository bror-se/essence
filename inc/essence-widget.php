...
class essence_vcard extends WP_Widget {
  ...
  ?>
    <p>
      <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title (optional):', 'essence'); ?></label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('street_address'); ?>"><?php _e('Street Address:', 'essence'); ?></label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('locality'); ?>"><?php _e('City/Locality:', 'essence'); ?></label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('region'); ?>"><?php _e('State/Region:', 'essence'); ?></label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('postal_code'); ?>"><?php _e('Zipcode/Postal Code:', 'essence'); ?></label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('tel'); ?>"><?php _e('Telephone:', 'essence'); ?></label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('Email:', 'essence'); ?></label>
